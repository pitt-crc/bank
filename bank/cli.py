...
class SlurmParser(system.SlurmAccount, ArgumentParser):
    ...
    def __init__(self) -> None:
        ...
        slurm_create.add_argument('--account', type=dao.SlurmAccount, help='The slurm account to administrate', dest='account_name')
        slurm_create.add_argument('--desc', type=dao.SlurmAccount, help='The description of the account', dest='description')
        slurm_create.add_argument('--org', type=dao.SlurmAccount, help='The parent organization of the account', dest='organization')
        ...
        slurm_delete.add_argument('--account', type=dao.SlurmAccount, help='The slurm account to administrate', dest='self')
        ...
        slurm_add_user.add_argument('--account', type=dao.SlurmAccount, help='The slurm account to administrate', dest='self')
        slurm_add_user.add_argument('--user', help='Optionally create a user under the parent slurm account', dest='user_name')
        ...
        slurm_delete_user.add_argument('--account', type=dao.SlurmAccount, help='The slurm account to administrate', dest='self')
        slurm_delete_user.add_argument('--user', help='Optionally create a user under the parent slurm account', dest='user_name')
        ...
        slurm_lock.add_argument('--account', type=dao.SlurmAccount, help='The slurm account to administrate', dest='self')
        ...
        slurm_unlock.add_argument('--account', type=dao.SlurmAccount, help='The slurm account to administrate', dest='self')
...
class ProposalParser(dao.ProposalAccount, ArgumentParser):
    ...
    def __init__(self) -> None:
        ...
        proposal_create.add_argument('--account', type=dao.ProposalAccount, help='The parent slurm account', dest='self')
        ...
        proposal_delete.add_argument('--account', type=dao.ProposalAccount, help='The parent slurm account', dest='self')
        ...
        proposal_add.add_argument('--account', type=dao.ProposalAccount, help='The parent slurm account', dest='self')
        ...
        proposal_subtract.add_argument('--account', type=dao.ProposalAccount, help='The parent slurm account', dest='self')
        ...
        proposal_overwrite.add_argument('--account', type=dao.ProposalAccount, help='The parent slurm account', dest='self')
...
class InvestmentParser(dao.InvestorAccount, ArgumentParser):
    ...
    def __init__(self) -> None:
        ...
        investment_create.add_argument('--account', type=dao.InvestorAccount, help='The parent slurm account', dest='self')
        ...
        investment_delete.add_argument('--account', type=dao.InvestorAccount, help='The parent slurm account', dest='self')
        ...
        investment_add.add_argument('--account', type=dao.InvestorAccount, help='The parent slurm account', dest='self')
        ...
        investment_subtract.add_argument('--account', type=dao.InvestorAccount, help='The parent slurm account', dest='self')
        ...
        investment_overwrite.add_argument('--account', type=dao.InvestorAccount, help='The parent slurm account', dest='self')
        ...
        investment_advance.add_argument('--account', type=dao.InvestorAccount, help='The parent slurm account', dest='self')
        ...
        investment_renew.add_argument('--account', type=dao.InvestorAccount, help='The parent slurm account', dest='self')
