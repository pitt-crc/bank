...
class SignatureMatchesCLI(TestCase, CLIAsserts):
    ...
    def test_create_investment(self) -> None:
        ...
        self.assert_parser_matches_func_signature(self.parser, f'create {settings.test_accounts[0]} --SUs 100')
    ...
    def test_add_sus(self) -> None:
        ...
        self.assert_parser_matches_func_signature(self.parser, f'add_sus {settings.test_accounts[0]} --SUs 100')

        # Add SUs to the active investment, providing a negative SU amount
        with self.assertRaises(SystemExit):
            self.assert_parser_matches_func_signature(
                self.parser,
                f'add_sus {settings.test_accounts[0]} --SUs -100')

        # Add SUs a specific investment
        self.assert_parser_matches_func_signature(self.parser, f'add_sus {settings.test_accounts[0]} --ID 0 --SUs 100')

        # Add SUs to a specific investment, providing a negative SU amount
        with self.assertRaises(SystemExit):
            self.assert_parser_matches_func_signature(
                self.parser,
                f'add_sus {settings.test_accounts[0]} --ID 0 --SUs -100')
    ...
    def test_subtract_sus(self) -> None:
        ...
        self.assert_parser_matches_func_signature(self.parser, f'subtract_sus {settings.test_accounts[0]} --SUs 100')
        ...
        self.assert_parser_matches_func_signature(self.parser, f'subtract_sus {settings.test_accounts[0]} --ID 0 --SUs 100')
    ...
    def test_advance_sus(self) -> None:
        ...
        self.assert_parser_matches_func_signature(self.parser, f'advance {settings.test_accounts[0]} --SUs 100')
        ...
        self.assert_parser_matches_func_signature(self.parser, f'advance {settings.test_accounts[0]} --ID 0 --SUs 100')
