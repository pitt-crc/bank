...
class GetProposal(ProposalSetup, TestCase):
...
class GetMissingProposal(EmptyAccountSetup, TestCase):
...
class GetInvestment(InvestmentSetup, TestCase):
...
class GetMissingInvestment(EmptyAccountSetup, TestCase):
