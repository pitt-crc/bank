...
class Instantiation(TestCase):
    ...
    def test_valid_account_name(self) -> None:
        ...
        self.assertEqual(TestSettings.test_accounts[0], account.account_name)
...
class CheckAccountExists(TestCase):
    ...
    def test_valid_account(self) -> None:
        ...
        self.assertTrue(SlurmAccount.check_account_exists(TestSettings.test_accounts[0]))
...
class AccountLocking(TestCase):
    ...
    def test_account_status_updated(self) -> None:
        ...
        account = SlurmAccount(TestSettings.test_accounts[0])
        account.set_locked_state(False, TestSettings.test_cluster)
        self.assertFalse(account.get_locked_state(TestSettings.test_cluster))

        account.set_locked_state(True, TestSettings.test_cluster)
        self.assertTrue(account.get_locked_state(TestSettings.test_cluster))
...
class GetClusterUsage(TestCase):
    ...
    def test_get_usage_hours(self) -> None:
        ...
        account = SlurmAccount(TestSettings.test_accounts[0])
        cluster = TestSettings.test_cluster
